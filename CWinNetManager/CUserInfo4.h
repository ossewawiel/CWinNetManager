// CUserInfo4.h : Declaration of the CCUserInfo4
...
class ATL_NO_VTABLE CCUserInfo4 :
	public CComObjectRootEx<CComMultiThreadModel>,
	public CComCoClass<CCUserInfo4, &CLSID_CUserInfo4>,
	public IDispatchImpl<ICUserInfo4, &IID_ICUserInfo4, &LIBID_CWinNetManagerLib, /*wMajor =*/ 1, /*wMinor =*/ 0>
{
public:
	CCUserInfo4()
		: m_bsName(L"")
...
DECLARE_REGISTRY_RESOURCEID(IDR_CUSERINFO4)


BEGIN_COM_MAP(CCUserInfo4)
	COM_INTERFACE_ENTRY(ICUserInfo4)
...
public:
	...
	static HRESULT TranslateFromUserInfo(LPUSER_INFO_4 pFrom, ICUserInfo4 ** ppTo);
private:
	_bstr_t m_bsName;
...
OBJECT_ENTRY_NON_CREATEABLE_EX_AUTO(__uuidof(CUserInfo4), CCUserInfo4)
